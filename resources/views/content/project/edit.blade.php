...
@if(Auth::user()->role == "admin")
	{!! Form::model($project,['url'=>'project/update/'.$project->id,'method'=>'put']) !!}
	<div class="row">
		<!-- left column -->
		<div class="col-md-8">
		...
		<div class="col-md-4">
			...
			<div class="box box-warning">
				...
				<div class="box-body">
					...
					<div class="form-group">
						...
						<input type="text" id="pic" value="{{ $project->client->name }}" class="form-control"  placeholder="PIC ..." disabled>
					</div>
					<div class="form-group">
						<label>Phone</label>
						<input type="text" id="phone" value="{{ $project->client->client->phone }}" class="form-control"  placeholder="Phone ..." disabled>
					</div>
					<div class="form-group">
						<label>Address</label>
						<textarea class="form-control" id="address" rows="3" placeholder="Address ..." disabled>{{ $project->client->client->address }}</textarea>
					</div>
			...
			<div class="box box-success">
				...
				<div class="box-body">
					...
					<div class="form-group">
						<label>Email</label>
						<input type="text" id="email" class="form-control" value="{{ $project->pm->email }}" placeholder="Email ..." disabled>
					</div>
...
@elseif(Auth::user()->role == "pm")
	{!! Form::model($project,['url'=>'project/patch/'.$project->id,'method'=>'patch']) !!}
	<div class="row">
		<!-- left column -->
		<div class="col-md-8">
			<!-- general form elements -->
			<div class="box box-primary">
				...
				<div class="box-body">
					<div class="form-group{{ $errors->has('p_name') ? ' has-error' : '' }}">
						<label for="exampleInputEmail1">Project Name</label>
						{!! Form::text("p_name",old('p_name'),['class'=>'form-control','placeholder'=>'Project Name','disabled'=>true]) !!}
						@if($errors->has('p_name'))
						<span class="help-block">
							<strong>{{ $errors->first('p_name') }}</strong>
						</span>
					...
					<div class="form-group{{ $errors->has('p_address') ? ' has-error' : '' }}">
						<label>Address</label>
						{!! Form::textarea('p_address',old('p_address'),['rows'=>'5','class'=>'form-control','placeholder' => 'Project Address','disabled'=>true]) !!}
						@if($errors->has('p_address'))
						<span class="help-block">
							<strong>{{ $errors->first('p_address') }}</strong>
						</span>
					...
					<div class="form-group{{ $errors->has('end_date') ? ' has-error' : '' }}">
						...
						<div class="input-group">
							<span class="input-group-addon"><i class="fa fa-calendar"></i></span>
							{!! Form::text('end_date',old('end_date'),['class'=>'form-control datepicker','placeholder'=>'End Date']) !!}
		...
		<div class="col-md-4">
			...
			<div class="box box-warning">
				...
				<div class="box-body">
					...
					<div class="form-group{{ $errors->has('client_id') ? ' has-error' : '' }}">
						<label>Company</label>
						{!! Form::select('client_id',$client,null,['class'=>'form-control select2','id'=>'client_id','placeholder'=>'Choose', "disabled" => true]) !!}
						@if($errors->has('client_id'))
						<span class="help-block">
							<strong>{{ $errors->first('client_id') }}</strong>
						</span>
			...
			<div class="box box-success">
				...
				<div class="box-body">
					...
					<div class="form-group{{ $errors->has('pm_id') ? ' has-error' : '' }}">
						<label>Project Manager</label>
						{!! Form::select('pm_id',$pm,null,['class'=>'form-control select2','id'=>'pm_id','placeholder'=>'Choose',"disabled"=>true]) !!}
						@if($errors->has('pm_id'))
						<span class="help-block">
							<strong>{{ $errors->first('pm_id') }}</strong>
						</span>
